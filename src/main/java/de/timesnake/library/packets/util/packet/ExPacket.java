...
public interface ExPacket {
  ...
  enum Type {
    ...
    PLAY_OUT_TABLIST_TEAM(PLAY_OUT_TABLIST_TEAM_CREATION, PLAY_OUT_TABLIST_TEAM_UPDATE,
        PLAY_OUT_TABLIST_TEAM_PLAYER_ADD, PLAY_OUT_TABLIST_TEAM_PLAYER_REMOVE,
        PLAY_OUT_TABLIST_TEAM_REMOVE),
    ...
    // tablist
    PLAY_OUT_TABLIST(PLAY_OUT_TABLIST_PLAYER, PLAY_OUT_TABLIST_TEAM,
        PLAY_OUT_TABLIST_HEADER_FOOTER),
    ...
    PLAY_OUT_ENTITY(PLAY_OUT_SPAWN_ENTITY_LIVING, PLAY_OUT_DESTROY_ENTITY,
        PLAY_OUT_SPAWN_NAMED_ENTITY,
    ...
    // play out
    PLAY_OUT(PLAY_OUT_TABLIST, PLAY_OUT_SIDEBOARD, PLAY_OUT_CHAT, PLAY_OUT_WORLD_BORDER,
        PLAY_OUT_SCOREBOARD_OBJ,
