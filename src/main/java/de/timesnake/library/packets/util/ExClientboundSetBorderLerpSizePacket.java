...
public interface ExClientboundSetBorderLerpSizePacket extends ExPacketPlayOutWorldBorder {
  ...
  static ExClientboundSetBorderLerpSizePacket wrap(World world, double newSize, double oldSize,
      long time) {
    return new de.timesnake.library.packets.core.packet.out.border.ExClientboundSetBorderLerpSizePacket(
        world,
