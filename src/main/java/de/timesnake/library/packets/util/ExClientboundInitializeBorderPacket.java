...
public interface ExClientboundInitializeBorderPacket extends ExPacketPlayOut,
  ...
  static ExClientboundInitializeBorderPacket wrap(World world, double centerX, double centerZ,
      double startSize,
      double shrinkSize, long time, int warningDistance,
      int warningTime) {
    return new de.timesnake.library.packets.core.packet.out.border.ExClientboundInitializeBorderPacket(
        world,
