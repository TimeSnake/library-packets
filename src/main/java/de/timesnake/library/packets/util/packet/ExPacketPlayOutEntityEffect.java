...
public interface ExPacketPlayOutEntityEffect extends ExPacketPlayOut {
  ...
  static ExPacketPlayOutEntityEffect wrap(Player player, Effect effect, byte amplifier,
      int duration,
      boolean ambient, boolean showParticles, boolean showIcon) {
    return new de.timesnake.library.packets.core.packet.out.entity.ExPacketPlayOutEntityEffect(
        player, effect,
