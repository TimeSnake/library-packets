...
public abstract class ExPacketPlayIn extends ExPacket implements
    de.timesnake.library.packets.util.packet.ExPacketPlayIn {

  public static ExPacketPlayIn getPacket(Packet<? extends PacketListener> packet)
