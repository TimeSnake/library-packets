...
public class ExPacketPlayOutEntityHeadRotation extends ExPacketPlayOut implements
    de.timesnake.library.packets.util.packet.ExPacketPlayOutEntityHeadRotation {

  public static ExPacketPlayOutEntityHeadRotation getPacket(
      PacketPlayOutEntityHeadRotation packet) {
  ...
  public ExPacketPlayOutEntityHeadRotation(
      de.timesnake.library.entities.entity.extension.Entity entity, float yaw) {
