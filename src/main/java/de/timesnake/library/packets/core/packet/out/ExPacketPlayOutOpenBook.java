...
public class ExPacketPlayOutOpenBook extends ExPacketPlayOut implements
    de.timesnake.library.packets.util.packet.ExPacketPlayOutOpenBook {
  ...
  public ExPacketPlayOutOpenBook(boolean mainHand) {
    super(new PacketPlayOutOpenBook(
        mainHand ? ExEnumHand.MAIN_HAND.getNMS() : ExEnumHand.OFF_HAND.getNMS()));
  }
