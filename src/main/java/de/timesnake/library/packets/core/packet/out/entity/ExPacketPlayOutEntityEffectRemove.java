...
public class ExPacketPlayOutEntityEffectRemove extends ExPacketPlayOut implements
    de.timesnake.library.packets.util.packet.ExPacketPlayOutEntityEffectRemove {

  public ExPacketPlayOutEntityEffectRemove(Player p, ExPacketPlayOutEntityEffect.Effect effect) {
    super.packet = new PacketPlayOutRemoveEntityEffect(p.getEntityId(),
        MobEffectList.a(effect.getId()));
  }
