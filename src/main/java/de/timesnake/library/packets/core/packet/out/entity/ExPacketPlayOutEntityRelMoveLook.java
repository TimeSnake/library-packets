...
public class ExPacketPlayOutEntityRelMoveLook extends ExPacketPlayOut implements
    de.timesnake.library.packets.util.packet.ExPacketPlayOutEntityRelMoveLook {

  public ExPacketPlayOutEntityRelMoveLook(LivingEntity entity, double deltaX, double deltaY,
      double deltaZ,
  ...
  public ExPacketPlayOutEntityRelMoveLook(ExEntityLiving entity, double deltaX, double deltaY,
      double deltaZ,
      float yaw, float pitch, boolean onGround) {
    super(new PacketPlayOutEntity.PacketPlayOutRelEntityMoveLook(entity.getId(),
        (short) (deltaX * 32 * 128),
