...
public abstract class ExPacketPlayOutSideboard extends ExPacketPlayOut implements
    de.timesnake.library.packets.util.packet.ExPacketPlayOutSideboard {

  public static ExPacketPlayOut getPacket(PacketPlayOutScoreboardScore packet)
  ...
  public ExPacketPlayOutSideboard(Packet<? extends PacketListener> packet, String sideboardName,
      int line,
      String text) {
    super(packet);
