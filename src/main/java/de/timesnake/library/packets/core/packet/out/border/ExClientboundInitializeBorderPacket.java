...
public class ExClientboundInitializeBorderPacket extends ExPacketPlayOut implements
    de.timesnake.library.packets.util.ExClientboundInitializeBorderPacket {

  public ExClientboundInitializeBorderPacket(ClientboundInitializeBorderPacket packet) {
    super(packet);
  }

  public ExClientboundInitializeBorderPacket(World world, double centerX, double centerZ,
      double startSize,
      double shrinkSize, long time, int warningDistance, int warningTime) {

    super(new ClientboundInitializeBorderPacket(
        new PacketWorldBorder(((CraftWorld) world).getHandle(), centerX,
