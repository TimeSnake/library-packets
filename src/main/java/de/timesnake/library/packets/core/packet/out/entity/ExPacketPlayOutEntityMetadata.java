...
public class ExPacketPlayOutEntityMetadata extends ExPacketPlayOut implements
		de.timesnake.library.packets.util.packet.ExPacketPlayOutEntityMetadata {
	...
	public ExPacketPlayOutEntityMetadata(Entity entity, DataType type) {
		if (type == DataType.UPDATE) {
			super.packet = new PacketPlayOutEntityMetadata(entity.getEntityId(),
					new ExEntity(((CraftEntity) entity)).getDataWatcher(), true);
		}
	}
	...
	public ExPacketPlayOutEntityMetadata(Entity entity, DataType type, boolean flag) {
		if (type == DataType.UPDATE) {
			super.packet = new PacketPlayOutEntityMetadata(entity.getEntityId(),
					new ExEntity(((CraftEntity) entity)).getDataWatcher(), flag);
		}
	}
	...
	public ExPacketPlayOutEntityMetadata cloneByte() {
		...
		PacketPlayOutEntityMetadata clonedPacket = new PacketPlayOutEntityMetadata(entityId,
				new DataWatcher(null),
				true);
