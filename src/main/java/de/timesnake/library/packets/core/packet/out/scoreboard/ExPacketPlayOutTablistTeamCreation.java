...
public class ExPacketPlayOutTablistTeamCreation extends ExPacketPlayOutTablistTeam implements
    de.timesnake.library.packets.util.packet.ExPacketPlayOutTablistTeamCreation {
  ...
  public ExPacketPlayOutTablistTeamCreation(PacketPlayOutScoreboardTeam packet, String name,
      String prefix) {
    super(packet, name);
    this.prefix = prefix;
  }
