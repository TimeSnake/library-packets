...
public class PacketWorldBorder extends WorldBorder {
  ...
  public static PacketWorldBorder lerp(WorldServer worldServer, double newSize, double oldSize,
      long time) {
  ...
  public static PacketWorldBorder init(WorldServer worldServer, double centerX, double centerZ,
      double newSize,
      double oldSize, long time, int warningDistance, int warningTime) {
    return new PacketWorldBorder(worldServer, centerX, centerZ, newSize, oldSize, time,
        warningDistance,
        warningTime);
  }
  ...
  public PacketWorldBorder(WorldServer worldServer, double centerX, double centerZ, double newSize,
      double oldSize,
